...
namespace Dekart.LazyNet.SQLBackup2Remote.Helpers
{
    ...
    public class MruListBox
    {
        ...
        protected ListBox recentFileMenuItem;
        ...
        public class MruMenuItem : ListBoxItem
        {
        ...
        public MruListBox(ListBox recentFileMenuItem, ClickedHandler clickedHandler)
        ...
        public MruListBox(ListBox recentFileMenuItem, ClickedHandler clickedHandler, int maxEntries)
        ...
        public MruListBox(ListBox recentFileMenuItem, ClickedHandler clickedHandler, string registryKeyName)
        ...
        public MruListBox(ListBox recentFileMenuItem, ClickedHandler clickedHandler, string registryKeyName, int maxEntries)
        ...
        public MruListBox(ListBox recentFileMenuItem, ClickedHandler clickedHandler, string registryKeyName, bool loadFromRegistry)
        ...
        /// <param labelName="loadFromRegistry">Loads the MRU settings from the registry immediately.</param>
        /// <param labelName="maxEntries">The maximum number of items on the MRU list.</param>
        public MruListBox(ListBox recentFileMenuItem, ClickedHandler clickedHandler, string registryKeyName, bool loadFromRegistry, int maxEntries)
        {
            Init(recentFileMenuItem, clickedHandler, registryKeyName, loadFromRegistry, maxEntries);
        }

        protected void Init(ListBox recentFileMenuItem, ClickedHandler clickedHandler, string registryKeyName, bool loadFromRegistry, int maxEntries)
        {
        ...
        public virtual ItemCollection MenuItems => recentFileMenuItem.Items;

        public virtual int StartIndex => 0;

        public virtual int EndIndex => numEntries;
        ...
        protected void FixupPrefixes(int startNumber)
        {
            ...
            if (startNumber < maxEntries)
            {
                for (int i = StartIndex + startNumber; i < EndIndex; i++, startNumber++)
                {
                    ...
                    int offset = ((MruMenuItem)MenuItems[i]).Text.Substring(0, 2) == "10" ? 4 : 3;
                    //MenuItems[i].Text = FixupEntryname(startNumber, MenuItems[i].Text.Substring(offset));
                    ((MruMenuItem)MenuItems[i]).Text = FixupEntryname(startNumber, ((MruMenuItem)MenuItems[i]).Text.Substring(offset));
        ...
        public string[] GetFilesFullEntrystring()
        {
            ...
            for (int i = 0; i < filenames.GetLength(0); i++, index++)
            {
                ...
                filenames[i] = ((MruMenuItem)MenuItems[index]).Text;
            }
